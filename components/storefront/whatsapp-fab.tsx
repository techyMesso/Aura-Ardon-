...
export function WhatsAppFab() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-4 z-40 inline-flex min-h-12 items-center gap-2 rounded-full bg-ink p-1.5 pr-4 text-sm font-semibold text-white shadow-[0_20px_50px_rgba(43,20,37,0.35)] transition hover:bg-bronze sm:right-5 lg:bottom-8 lg:right-8"
